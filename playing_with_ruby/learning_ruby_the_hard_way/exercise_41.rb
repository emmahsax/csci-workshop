## This program was designed to help us "speak object-oriented".
## To run, type <ruby exercise_41.rb> into the terminal, and press RETURN when you want to see an answer.
