...
func main() {
	...
	myCar.changeCar2("Honda", 25000) // this is the same as above, due to Go automatically making it work
	fmt.Println(myCar)               // -> {Honda 25000}

	// declaring a pointer to car
	yourCar := &myCar     // it stores the address of myCar
	fmt.Println(*yourCar) // -> {Honda 25000}
