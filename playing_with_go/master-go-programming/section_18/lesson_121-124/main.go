...
func main() {
	...
	// combining different fields of the same type on the same line; this is the same as above
	// type book struct {
	//     title, author string
	//     year, pages   int
	// }
	...
	// this is only acceptable if the struct doesn't declare fields on the same lines
