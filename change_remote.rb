# This script will go through every directory in a directory, see if it is a git directory,
# and then will check to see if the old username is included in the remote URL of that git
# directory. If it is, then the script will change the remote URL to instead point to the
# new username's remote URL.
